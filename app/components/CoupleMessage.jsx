...
export default function CoupleMessage() {
    ...
    return (
        ...
        <div className="bg-[url('/assets/backmid.png')] bg-cover bg-no-repeat">
            <div className="lg:h-600 md:h-520 h-515">
                ...
                <div className="flex flex-col justify-center items-center mt-28">
                    <h2 className="lg:text-3xl text-xl text-center text-white lg:pt-6 font-cormorant-upright">Please help us capture our special day, use the hashtag</h2>
